        ...
        <div className='site flex flex-col h-full w-full bg-gray-900 font-vietnam'>
            ...
            <div className='flex w-full h-full'>
                <div className='flex flex-col mt-24 text-white justify-center text-center items-center'>
                    <h1 className='text-4xl underline mb-4'>About NodePath</h1>
                    <div className='w-1/2 h-1/2'>
                        <img src={`${prefix}/images/network.png`}></img>
                    </div>
                    <div className='w-3/5 h-full mb-12'>
                        <div id="about" className='mb-8'>
                            <h2 className='text-2xl text-teal-500'>What is NodePath?</h2>
                            <p className='text-lg'>NodePath is an online visualization platform for both the structure and training of <a href="https://en.wikipedia.org/wiki/Multilayer_perceptron" target="_blank">multiplayer perceptron</a> (MLP) <a href="https://en.wikipedia.org/wiki/Feedforward_neural_network" target="_blank">feed-forward neural networks.</a></p>
                        </div>
                        <div id="use" className='mb-8'>
                            <h2 className='text-2xl text-teal-500'>What can I use it for?</h2>
                            <p className='text-lg'>You can use NodePath for training, visualizing, and experimenting with a variety of different feed-forward neural network architectures on your own training datasets. 
                        ...
                        <div id="made" className='mb-8'>
                            ...
                            <p className='text-lg'>NodePath is made with <Link href="https://nextjs.org/"><a target="_blank">Next.js</a></Link> and <a href="https://reactjs.org/" target="_blank">React</a> with <a href="https://tailwindcss.com/" target="_blank">Tailwind</a> for styling. 
                        ...
                        <div id="open-source" className='mb-8'>
                            ...
                            <p className='text-lg'>Absolutely! NodePath is entirely open-source and available on <a href="https://github.com/ahluwalij/NodePath">GitHub. </a>
                            If you enjoy NodePath and find it helpful, consider leaving a star on the repository! If not, please feel free to file an issue and describe how you feel it could be improved. </p>
                        </div>
                        <div id="datasets" className='mb-8'>
                            <h2 className='text-2xl text-teal-500'>I'd like to try NodePath, but I don't have a dataset...</h2>
                            <p className='text-lg'>NodePath was created to help people develop a better understanding of the structure and training of neural networks on their own datasets, but if 
                            you just want to experiment with the site and explore its capabilities, that's perfectly fine! A number of feasible datasets are readily available on the <a href="https://github.com/ahluwalij/NodePath/tree/master/datasets" target="_blank">GitHub repository</a> for you to use.
                        ...
                        <div id="limits" className='mb-8'>
                            ...
                            <p className='text-lg'>As mentioned, NodePath can visualize and train multilayer perceptron feed-forward neural networks. 
                            ...
                            NodePath also allows a maximum of 1000 nodes in any individual layer to ease the load on your browser.
                            Additionally, all models trained on NodePath make use of the <a href="https://en.wikipedia.org/wiki/Logistic_function" target="_blank">Sigmoid</a> <a href="https://en.wikipedia.org/wiki/Activation_function" target="_blank">activation function</a> at hidden layers. 
                            ...
                            In the future, NodePath will support the selection of different activation functions based on model purpose. </p>
                        </div>
                    </div>
                    <div className='w-3/5 h-full'>
                        ...
                        <div id="inaccurate" className='mb-8'>
                            ...
                            <p className='text-lg'>Neural network model accuracy is highly dependant on features such as network architecture, training rate, and the quality and quantity of its training dataset. Use NodePath as a platform to experiment with different architectures and settings!
